...
public:
    ...
    virtual void set(unsigned int row, unsigned int column, uint8_t red, uint8_t green, uint8_t blue) {}

    void fill(uint8_t red, uint8_t green, uint8_t blue);

    void display_text(unsigned int row, unsigned int column, std::string text, uint8_t red, uint8_t green, uint8_t blue);

    void display_rectangle(unsigned int from_row, unsigned int from_column, unsigned int to_row, unsigned int to_column,
